...
read_chunk("./analysis/1-behavior-outcome-change/1-BO-change-matrix-joey.R") 
```
...
### Basic
```{r graph-data, echo=TRUE, results='show', message=FALSE, fig.width=12, fig.height=10}
```

### Person
```{r person-by-school, echo=TRUE, results='show', message=FALSE, fig.width=15, fig.height=10, out.width=5000, out.height=5000}
```
